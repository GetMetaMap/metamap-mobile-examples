...
const ItemOptions = class {
  ...
  render() {
    const mode = Object(_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
    const isEnd = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(this.side);
...
const ItemSliding = class {
  ...
  async open(side) {
    ...
    side = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(side) ? 'end' : 'start';
  ...
  async updateOptions() {
    ...
    for (let i = 0; i < options.length; i++) {
      ...
      const side = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(option.side) ? 'end' : 'start';
      if (side === 'start') {
