(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[20], {
    ...
    function TvZU(module, __webpack_exports__, __webpack_require__) {
      ...
      var _index_899f6740_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./index-899f6740.js */
      "+DET");
      /* harmony import */
      ...
      var _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./overlays-738d7bc9.js */
      "PdNu");
      /* harmony import */
      ...
      var _framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./framework-delegate-4392cd63.js */
      "acej"); // Defaults for the card swipe animation
      ...
      var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
        ...
        var onMove = function onMove(detail) {
          var step = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(0.0001, detail.deltaY / height, 0.9999);
      ...
      var computeDuration = function computeDuration(remaining, velocity) {
        return Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(400, remaining / Math.abs(velocity * 1.1), 500);
      };
      /**
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
        var backdropAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
          'pointer-events': 'none'
        }).afterClearStyles(['pointer-events']);
        var wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        var baseAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().afterStyles({
                'transform': _finalTransform
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
        ...
        var backdropAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
        var wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        var baseAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
      ...
      var mdEnterAnimation = function mdEnterAnimation(baseEl) {
        var baseAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        var backdropAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
        var wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
      ...
      var Modal = /*#__PURE__*/function () {
        function Modal(hostRef) {
          ...
          this.onBackdropTap = function () {
            _this.dismiss(undefined, _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["B"]);
          };
        ...
        _createClass(Modal, [{
          ...
          value: function connectedCallback() {
            Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["e"])(this.el);
          }
          /**
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 5:
                      ...
                      _context.next = 8;
                      return Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);

                    case 8:
                      this.usersElement = _context.sent;
                      _context.next = 11;
                      return Object(_index_899f6740_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
                    ...
                    case 11:
                      ...
                      _context.next = 14;
                      return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      enteringAnimation = _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["h"].get(this) || [];
                      _context3.next = 5;
                      return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
                    ...
                    case 5:
                      ...
                      _context3.next = 9;
                      return Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__["d"])(this.delegate, this.usersElement);
          ...
          value: function onDidDismiss() {
            return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["g"])(this.el, 'ionModalDidDismiss');
          }
          /**
          ...
          value: function onWillDismiss() {
            return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["g"])(this.el, 'ionModalWillDismiss');
          }
        }, {
          key: "render",
