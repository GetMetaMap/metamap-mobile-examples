...
/* harmony import */ var _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./overlays-738d7bc9.js */ "PdNu");
/* harmony import */ var _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./theme-ff3fc52f.js */ "74mu");
/* harmony import */ var _framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./framework-delegate-4392cd63.js */ "acej");
...
const mdEnterAnimation = (baseEl, ev) => {
  ...
  const viewportAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])();
  backdropAnimation
    .addElement(baseEl.querySelector('ion-backdrop'))
    .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
    .beforeStyles({
...
const Popover = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["B"]);
    };
  ...
  connectedCallback() {
    Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["e"])(this.el);
  }
  /**
  ...
  async present() {
    ...
    this.usersElement = await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_8__["a"])(this.delegate, container, this.component, ['popover-viewport', this.el['s-sc']], data);
    await Object(_index_899f6740_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this, 'popoverEnter', iosEnterAnimation, mdEnterAnimation, this.event);
  }
  /**
  ...
  async dismiss(data, role) {
    const shouldDismiss = await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["f"])(this, data, role, 'popoverLeave', iosLeaveAnimation, mdLeaveAnimation, this.event);
    if (shouldDismiss) {
      await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_8__["d"])(this.delegate, this.usersElement);
    }
   ...
   */
  onDidDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionPopoverDidDismiss');
  }
  /**
   * Returns a promise that resolves when the popover will dismiss.
   */
  onWillDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionPopoverWillDismiss');
  }
  render() {
