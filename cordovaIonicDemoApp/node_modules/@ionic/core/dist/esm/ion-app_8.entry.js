...
import { a as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-5d0c8232.js';
...
import { a as attachComponent, d as detachComponent } from './framework-delegate-897f849d.js';
import { t as transition } from './index-e6cecce9.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean('_testing')) {
          import('./index-0bc00b33.js').then((module) => module.startTapClick(config));
        }
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-20472ffa.js').then((module) => module.startStatusTap());
        }
        if (config.getBoolean('inputShims', needInputShims())) {
          import('./input-shims-6ed8f5a5.js').then((module) => module.startInputShims(config));
        }
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import('./swipe-back-5351da01.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => { var _a; return (_a = this.ani) === null || _a === void 0 ? void 0 : _a.progressStep(step); }, (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
