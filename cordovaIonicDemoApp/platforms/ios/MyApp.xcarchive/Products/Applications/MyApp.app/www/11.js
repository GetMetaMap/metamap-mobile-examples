...
/* harmony import */ var _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./overlays-738d7bc9.js */ "PdNu");
...
const Datetime = class {
  ...
  async open() {
    ...
    const picker = await _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["p"].create(pickerOptions);
...
const Picker = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["B"]);
    };
    this.dispatchCancelHandler = (ev) => {
      const role = ev.detail.role;
      if (Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["i"])(role)) {
  ...
  connectedCallback() {
    Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["e"])(this.el);
  }
  /**
   * Present the picker overlay after it has been created.
   */
  async present() {
    await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["d"])(this, 'pickerEnter', iosEnterAnimation, iosEnterAnimation, undefined);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["f"])(this, data, role, 'pickerLeave', iosLeaveAnimation, iosLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the picker did dismiss.
   */
  onDidDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["g"])(this.el, 'ionPickerDidDismiss');
  }
  /**
   * Returns a promise that resolves when the picker will dismiss.
   */
  onWillDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["g"])(this.el, 'ionPickerWillDismiss');
  }
  /**
  ...
  async callButtonHandler(button) {
    if (button) {
      ...
      const rtn = await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_5__["s"])(button.handler, this.getSelected());
      if (rtn === false) {
