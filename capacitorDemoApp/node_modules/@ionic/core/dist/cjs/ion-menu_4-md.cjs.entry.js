...
require('./animation-cdda84bd.js');
const index = require('./index-d32614ae.js');
const index$1 = require('./index-247d17a6.js');
...
`);
    ...
    onEnd(detail) {
         ...
         */
        newStepValue += cubicBezier.getTimeGivenProgression(new cubicBezier.Point(0, 0), new cubicBezier.Point(0.4, 0), new cubicBezier.Point(0.6, 1), new cubicBezier.Point(1, 1), adjustedStepValue);
        this.animation
