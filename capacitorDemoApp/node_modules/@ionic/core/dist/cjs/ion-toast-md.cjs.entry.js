...
const animation = require('./animation-cdda84bd.js');
...
const Toast = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { style: {
            ...
            }, class: Object.assign(Object.assign(Object.assign({ [mode]: true }, theme.createColorClasses(this.color)), theme.getClassMap(this.cssClass)), { 'toast-translucent': this.translucent }) }, core.h("div", { class: wrapperClass }, core.h("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), core.h("div", { class: "toast-content" }, this.header !== undefined &&
