...
const Toast = class {
  constructor(hostRef) {
    ...
    this.dispatchCancelHandler = (ev) => {
      ...
      if (Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["i"])(role)) {
   ...
   */
  async present() {
    await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, this.position);
    if (this.duration > 0) {
  ...
  dismiss(data, role) {
    ...
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["f"])(this, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation, this.position);
  }
  /**
   * Returns a promise that resolves when the toast did dismiss.
   */
  onDidDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["g"])(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  async callButtonHandler(button) {
    if (button && button.handler) {
      ...
      try {
        const rtn = await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_6__["s"])(button.handler);
        if (rtn === false) {
