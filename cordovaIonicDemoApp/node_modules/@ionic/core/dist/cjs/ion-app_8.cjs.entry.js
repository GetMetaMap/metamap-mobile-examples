...
const index$1 = require('./index-6a90f160.js');
const keyboardController = require('./keyboard-controller-5bc768a7.js');
const cubicBezier = require('./cubic-bezier-16d7da31.js');
const frameworkDelegate = require('./framework-delegate-c3b5ccd5.js');
const index$2 = require('./index-badff179.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!ionicGlobal.config.getBoolean('_testing')) {
          Promise.resolve().then(function () { return require('./index-3340c5ac.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
        }
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-fc7ea02c.js'); }).then((module) => module.startStatusTap());
        }
        if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
          Promise.resolve().then(function () { return require('./input-shims-73ba6cc9.js'); }).then((module) => module.startInputShims(ionicGlobal.config));
        }
        ...
        Promise.resolve().then(function () { return require('./focus-visible-5c8b6fa3.js'); }).then((module) => (this.focusVisible = module.startFocusVisible()));
      });
    }
  }
  /**
