...
/* harmony import */ var _framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./framework-delegate-4392cd63.js */ "acej");
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('_testing')) {
          __webpack_require__.e(/*! import() | tap-click-cc1ae2b2-js */ "tap-click-cc1ae2b2-js").then(__webpack_require__.bind(null, /*! ./tap-click-cc1ae2b2.js */ "cg4z")).then(module => module.startTapClick(_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["c"]));
        }
        if (_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() | status-tap-3a499f55-js */ "status-tap-3a499f55-js").then(__webpack_require__.bind(null, /*! ./status-tap-3a499f55.js */ "dL/K")).then(module => module.startStatusTap());
        }
        if (_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('inputShims', needInputShims())) {
          __webpack_require__.e(/*! import() | input-shims-7ec33d9a-js */ "input-shims-7ec33d9a-js").then(__webpack_require__.bind(null, /*! ./input-shims-7ec33d9a.js */ "BWrR")).then(module => module.startInputShims(_ionic_global_ddef3a45_js__WEBPACK_IMPORTED_MODULE_1__["c"]));
        }
...
const handleContentScroll = (scrollEl, scrollHeaderIndex, contentEl) => {
  Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["f"])(() => {
    ...
    const scale = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(1, 1 + (-scrollTop / 500), 1.1);
...
const RouterOutlet = class {
  ...
  async connectedCallback() {
    this.gesture = (await __webpack_require__.e(/*! import() | swipe-back-7ed48517-js */ "swipe-back-7ed48517-js").then(__webpack_require__.bind(null, /*! ./swipe-back-7ed48517.js */ "FOHg"))).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
  ...
  async setRoot(component, params, opts) {
    ...
    const enteringEl = await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_6__["a"])(this.delegate, this.el, component, ['ion-page', 'ion-page-invisible'], params);
    this.activeComponent = component;
    this.activeEl = enteringEl;
    // commit animation
    await this.commit(enteringEl, leavingEl, opts);
    await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this.delegate, leavingEl);
    return true;
  }
  async transition(enteringEl, leavingEl, opts = {}) {
    ...
    await Object(_index_899f6740_js__WEBPACK_IMPORTED_MODULE_3__["t"])(Object.assign(Object.assign({ mode,
      animated,
      enteringEl,
