...
/* harmony import */ var _index_899f6740_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-899f6740.js */ "+DET");
...
/* harmony import */ var _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./overlays-738d7bc9.js */ "PdNu");
/* harmony import */ var _theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./theme-ff3fc52f.js */ "74mu");
/* harmony import */ var _framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./framework-delegate-4392cd63.js */ "acej");
...
const createSwipeToCloseGesture = (el, animation, onDismiss) => {
  ...
  const onMove = (detail) => {
    const step = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(0.0001, detail.deltaY / height, 0.9999);
...
const iosEnterAnimation = (baseEl, presentingEl) => {
  ...
  const wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
  ...
  if (presentingEl) {
    ...
    const presentingAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
      .beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_3__["c"])()
          .afterStyles({
          'transform': finalTransform
        })
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["B"]);
    };
    this.onDismiss = (ev) => {
      ev.stopPropagation();
      ev.preventDefault();
  ...
  async present() {
    ...
    this.usersElement = await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);
    await Object(_index_899f6740_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
    Object(_index_3ccd7557_js__WEBPACK_IMPORTED_MODULE_0__["c"])(() => this.el.classList.add('show-modal'));
    await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
  ...
  async dismiss(data, role) {
    ...
    const enteringAnimation = _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["h"].get(this) || [];
    const dismissed = await Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_9__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    if (dismissed) {
      await Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_11__["d"])(this.delegate, this.usersElement);
      if (this.animation) {
