...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Tab One\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    \n  <ion-button className=\"matiButtonCss\" (click)=\"showMatiFlow()\">Show MatiFLow</ion-button>\n \n</ion-content>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".matiButtonCss {\n  padding-top: 200px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var MatiCapacitorPlugin = _capacitor_core__WEBPACK_IMPORTED_MODULE_1__["Plugins"].MatiCapacitorPlugin;
var Tab1Page = /** @class */ (function () {
    function Tab1Page() {
    }
    // the method that starts to show FLOW screens
    Tab1Page.prototype.showMatiFlow = function () {
        MatiCapacitorPlugin.showMatiFlow();
    };
    Tab1Page.prototype.ionViewDidEnter = function () {
        var metadataParams = { param1: "value1" }; // variable for metadata params
        var registerParams = { clientId: "5c94e3c401ddc6001be83c07", flowId: "", metadata: metadataParams }; // variable for register params
        MatiCapacitorPlugin.setParams(registerParams); // initialization main class
        // methods handle of result
        window.addEventListener('Verification success', function (verificationId) {
            console.log("verification success:" + verificationId);
        });
        window.addEventListener('Verification cancelled', function () {
