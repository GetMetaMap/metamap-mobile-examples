...
/* harmony import */ var _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-738d7bc9.js */ "PdNu");
...
const Alert = class {
  constructor(hostRef) {
    ...
    this.animated = true;
    this.onBackdropTap = () => {
      this.dismiss(undefined, _overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["B"]);
    };
    this.dispatchCancelHandler = (ev) => {
      const role = ev.detail.role;
      if (Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["i"])(role)) {
  ...
  connectedCallback() {
    Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["e"])(this.el);
  }
  componentWillLoad() {
    this.inputsChanged();
    this.buttonsChanged();
   ...
   */
  present() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["d"])(this, 'alertEnter', iosEnterAnimation, mdEnterAnimation);
  }
  /**
   ...
   */
  dismiss(data, role) {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["f"])(this, data, role, 'alertLeave', iosLeaveAnimation, mdLeaveAnimation);
  }
  /**
   * Returns a promise that resolves when the alert did dismiss.
   */
  onDidDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.el, 'ionAlertDidDismiss');
  }
  /**
   * Returns a promise that resolves when the alert will dismiss.
   */
  onWillDismiss() {
    return Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.el, 'ionAlertWillDismiss');
  }
  rbClick(selectedInput) {
    ...
    Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["s"])(selectedInput.handler, selectedInput);
  ...
  callButtonHandler(button, data) {
    if (button && button.handler) {
      ...
      const returnData = Object(_overlays_738d7bc9_js__WEBPACK_IMPORTED_MODULE_8__["s"])(button.handler, data);
      if (returnData === false) {
